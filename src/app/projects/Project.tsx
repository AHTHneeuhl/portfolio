...
const Project: React.FC<TProps> = ({
  ...
  return (
    <div className="w-[720px] p-4 hover:border flex flex-row items-center gap-5 hover:border-neutral-200 transition cursor-pointer rounded-xl border border-white">
